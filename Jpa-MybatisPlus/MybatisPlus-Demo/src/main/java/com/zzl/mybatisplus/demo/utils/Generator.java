package com.zzl.mybatisplus.demo.utils;
...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        //这个 目录是自己项目的目录的名称
        String filePath = canonicalPath + "\\Jpa-MybatisPlus\\MybatisPlus-Demo\\src\\main\\";
        ...
        dsc.setUrl("jdbc:mysql:///demo_test?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC");
        ...
        pc.setParent("com.zzl.mybatisplus.demo.domain");// 自定义包路径
